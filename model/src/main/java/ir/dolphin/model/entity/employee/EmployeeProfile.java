...
@NamedQueries({
        @NamedQuery(name = "EmployeeProfile.findAll", query = "SELECT emp FROM EmployeeProfile emp"),
        @NamedQuery(name = "SallerProfile.findByNationalCode", query = "SELECT emp FROM EmployeeProfile emp where emp.nationalCode =:nationalCode")
})

public class EmployeeProfile implements Serializable, BaseStaticEntity {
